...
def main():
	...
	parser.add_argument('--batch_size', type=int, default=1, help="set training batch size")
	...
	parser.add_argument('--lambda_perceptual', type=float, default=10.0, help="")
	parser.add_argument("--lambda_pixel_wise", type=float, default=1.0, help="")
	
	parser.add_argument('--lambda_shape', type=float, default=1.0, help="")
	parser.add_argument("--lambda_mouth_shape",type=float, default=1.0, help="")
	parser.add_argument("--lambda_eye_shape", type=float, default=1.0, help="")
	parser.add_argument("--lambda_w_reg", type=float, default=0.0, help="w regularizer")
	...
	parser.add_argument("--shift_scale", type=float, default=6.0, help="maximum shift scale")
	parser.add_argument("--min_shift", type=float, default=0.1, help="minimum shift scale")
	parser.add_argument("--learned_directions", type=int, default=15, help="number of directions to learn")
	parser.add_argument("--num_layers_shift", type = int, default=8, help="number of layers to add the shift")
	parser.add_argument("--w_plus", type=bool, default=True, help="set w_plus True")
	parser.add_argument("--disentanglement_50", type=bool, default=True, help="set True to train half images on the batch changing only one direction")
 
 

	parser.add_argument('--steps_per_log', type=int, default=10, help="print log")
	parser.add_argument('--steps_per_save_models', type=int, default=100, help="steps per save model")
	parser.add_argument('--steps_per_evaluation', type=int, default=50, help="steps per evaluation during training")
